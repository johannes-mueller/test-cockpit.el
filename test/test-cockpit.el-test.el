...
(defun tc--register-foo-project (test-string)
  ...
  (mocker-let ((projectile-project-type () ((:output 'foo-project-type :min-occur 0)))
               (projectile-project-root (&optional dir) ((:input-matcher (lambda (_dir) t) :output "foo-project" :min-occur 0))))
...
(ert-deftest test-custom-action-replace-project-root ()
  (tc--register-foo-project "foo")
  (mocker-let ((projectile-project-type () ((:output 'foo-project-type)))
               (projectile-project-root (&optional dir) ((:input-matcher (lambda (_dir) t) :output "/path/to/project")))
               (buffer-file-name () ((:output "/path/to/project/some/file.el")))
...
(ert-deftest test-repeat-transient-suffix-non-nil ()
  (tc--register-foo-project "foo")
  (mocker-let ((projectile-project-type () ((:output 'foo-project-type)))
               (projectile-project-root (&optional dir) ((:input-matcher (lambda (_dir) t) :output "/home/user/projects/foo-project")))
               (compile (command) ((:input '("test project") :output 'success))))
